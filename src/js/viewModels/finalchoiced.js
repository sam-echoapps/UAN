    ...
    function (oj,ko,$, app, ArrayDataProvider, ListDataProviderView, ojdataprovider_1) {
        ...
        class FinalChoiced {
            constructor(args) {
                ...
                self.finalChoiceCnt = ko.observable();
                ...
                self.officeChangeHandler = (e)=>{
                    ...
                    self.getAllFinalChoicedApplication()
                }
                ...
                self.getAllFinalChoicedApplication = ()=>{
                    ...
                    $.ajax({
                        url: BaseURL+"/getAllFinalChoicedApplication",
                        type: 'POST',
                        data: JSON.stringify({
